...
export function adminOutputInviteSection(user) {
...
export function outputInviteDiv() {
...
export function sendInvitations() {
    ...
    // move this to chat.js
    // find all other emits out of chat.js and refactor into chat.js
